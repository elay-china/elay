package org.elay.common.mybatis.handler;
...
import org.elay.common.core.domain.dto.RoleDTO;
...
import org.elay.common.mybatis.enums.DataScopeType;
        ...
        for (RoleDTO role : user.getRoles()) {
            ...
            for (DataColumn dataColumn : dataPermission.value()) {
                ...
                if (ignoreMap.containsKey(dataColumn)) {
                    // 修复多角色与权限标识符共用问题 https://gitee.com/dromara/Elay/issues/IB4CS4
